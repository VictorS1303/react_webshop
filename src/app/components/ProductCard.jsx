...
export default function ProductCard() 
{
    return (
        ...
        <>
            ...
            <Link href="#" className="absolute bottom-4 left-[50%] -translate-x-[50%] bg-green-500 text-white p-2 w-fit whitespace-nowrap rounded-md cursor-pointer">Show Product</Link>
            </article>
